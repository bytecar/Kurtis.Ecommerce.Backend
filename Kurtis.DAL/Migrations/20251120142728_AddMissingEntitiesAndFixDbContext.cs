...
{
    /// <inheritdoc />
    public partial class AddMissingEntitiesAndFixDbContext : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<int>(type: "int", nullable: false),
                    FavoriteCategoriesJson = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    FavoriteColorsJson = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    FavoriteOccasionsJson = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PriceRangeMin = table.Column<int>(type: "int", nullable: true),
                    PriceRangeMax = table.Column<int>(type: "int", nullable: true),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Returns_Status_CreatedAt",
                table: "Returns",
